...
VALUES
  ('Sina Mendez', 'sina77@gmail.com', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u.'),
...
VALUES
  ...
  250, 2, 3, 4, 
  'USA', '123 Seaside Ave', 'Miami', 'Florida', '33101', true),
  ...
  350, 3, 4, 5, 
  'Canada', '456 Mountain Rd', 'Vancouver', 'British Columbia', 'V5K 1A1', true),
  ...
  180, 1, 2, 2, 
  'USA', '789 City St', 'New York', 'New York', '10001', true);
...
VALUES 
  (1, 1, 1, 5, 'Absolutely amazing stay! The villa was right by the beach, and the view was breathtaking. Highly recommend!'),
  (2, 2, 2, 4, 'A peaceful getaway. The retreat was beautiful, but we expected a little more luxury for the price. Still, a very relaxing stay.'),
  (3, 3, 3, 4, 'Great location in downtown New York! The loft was modern and well-equipped, though a bit smaller than we anticipated. Overall, a great experience.');
